# GitHub Copilot Instructions for synedgy.universal.helper
...
- Module name: `synedgy.universal.helper`
...
- `source/Public/UDComponents/` contains shared Universal Dashboard job UI components
  (`New-UDPsuJobHeader`, `New-UDPsuJobTerminalView`) used across consuming projects. See
  `README.md` for usage and known PSU platform behaviors relevant to this module.
